...
class Category(Base):
    ...
    recipes: Mapped[list["Recipe"]] = relationship(
        "Recipe", back_populates="category", cascade="all, delete-orphan", init=False
    )
...
class Recipe(Base):
    ...
    category_id: Mapped[uuid_pkg.UUID | None] = mapped_column(
    ...
    ingredients: Mapped[list["Ingredient"]] = relationship(
        "Ingredient", back_populates="recipe", cascade="all, delete-orphan", init=False
    )
